...
# Allows for relative URL setting for media root and others.
# From django-cms
PROJECT_PATH = os.path.abspath(os.path.dirname(__file__))

# Django settings for django_cms_quickstart project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    # TODO: INSERT YOUR NAME AND EMAIL
...
# TODO: SET YOUR SECRET KEY
SECRET_KEY = '_v9r(v6826v-cwpnrr9d#1kdj9haj*6qcpk$#&amp;czp&amp;8943l3(8'
